...
EnB = 32			# set pwm2 pin on MD10-Hat
ENA = 33			# set pwm1 pin on MD10-hat
DIG2 = 24				# set dir2 pin on MD10-Hat
DIG1 = 26				# set dir1 pin on MD10-Hat
GPIO.setup(EnB, GPIO.OUT)		# set pin as output
GPIO.setup(ENA, GPIO.OUT)		# set pin as output
GPIO.setup(DIG2, GPIO.OUT)		# set pin as output
GPIO.setup(DIG1, GPIO.OUT)		# set pin as output
sleep(1)				# delay for 1 seconds
p1 = GPIO.PWM(ENA, 100)			# set pwm for M1
p2 = GPIO.PWM(EnB, 100)			# set pwm for M2
...
try:
    while True:
        ...
        # set DIG2 as HIGH, to control direction
